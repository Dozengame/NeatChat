...
const cn = {
  ...
  Chat: {
    ...
    ChatToolMenu: {
      ...
      UploadImage: "上传图片",
      UploadImageDescription: "添加视觉参考",
      UploadFile: "上传文件",
      UploadFileDescription: "PDF、文档、代码或数据",
      ImageUploadUnavailable: "当前模型不支持图片附件",
      PromptLibrary: "提示词库",
      PromptLibraryDescription: "插入可复用提示词",
      PromptLibraryTitle: "提示词库",
      PromptLibrarySearch: "搜索提示词",
      PromptLibraryBack: "返回工具",
      PromptLibraryEmpty: "未找到提示词",
      PromptLibraryAll: "全部",
      PromptLibraryUser: "我的提示词",
      PromptLibraryBuiltin: "官方",
