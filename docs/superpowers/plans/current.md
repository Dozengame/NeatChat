...
- Branch: `dev`.
- Current HEAD: `b7a56703 fix(markdown): refine adaptive content surfaces`.
- The full Markdown visual follow-up is committed locally on `dev`; no push, PR, deploy, or remote configuration change was performed.
